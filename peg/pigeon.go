...
var g = &grammar{
	rules: []*rule{
			...
			expr: &actionExpr{
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&zeroOrMoreExpr{
							pos: position{line: 204, col: 24, offset: 5902},
							expr: &choiceExpr{
		...
		},
		{
			...
			expr: &zeroOrMoreExpr{
				pos: position{line: 228, col: 8, offset: 6591},
				expr: &choiceExpr{
		...
		},
		{
			...
			expr: &zeroOrMoreExpr{
				pos: position{line: 230, col: 6, offset: 6641},
				expr: &choiceExpr{
		...
		},
		{
			...
			expr: &zeroOrMoreExpr{
				pos: position{line: 231, col: 5, offset: 6679},
				expr: &choiceExpr{
