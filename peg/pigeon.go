...
var g = &grammar{
	rules: []*rule{
			...
			expr: &actionExpr{
				...
				expr: &seqExpr{
					...
					exprs: []interface{}{
						...
						&zeroOrMoreExpr{
							pos: position{line: 199, col: 24, offset: 5801},
							expr: &choiceExpr{
		...
		},
		{
			...
			expr: &zeroOrMoreExpr{
				pos: position{line: 223, col: 8, offset: 6490},
				expr: &choiceExpr{
		...
		},
		{
			...
			expr: &zeroOrMoreExpr{
				pos: position{line: 225, col: 6, offset: 6540},
				expr: &choiceExpr{
		...
		},
		{
			...
			expr: &zeroOrMoreExpr{
				pos: position{line: 226, col: 5, offset: 6578},
				expr: &choiceExpr{
